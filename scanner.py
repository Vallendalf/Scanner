...
try:
	...
	print("Podaj adres badanej strony!")
...
with open("dict.txt", "r") as f:
	wszystko = f.readlines()
	for i, podstrona in enumerate(wszystko):
		podstrona = podstrona.strip()
		if not "# " in podstrona and podstrona != "#" and len(podstrona) > 0:
			try:
				if i % 50 == 0:
					print(f"{round(i/len(wszystko)*100, 2)}%        ", end="\r")
				...
				pass # Strona nie istnieje
print(">>> Zakonczono skanowanie!")
